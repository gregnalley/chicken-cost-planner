...
"PRD-004": {
  ...
  title:
    "PVC Chicken Feeder Ports",

  description:
    "PVC feeder ports can be installed in a food-grade bucket, barrel, or similar container to create a high-capacity gravity feeder. This is a useful option for chicken keepers who want fewer refills and are comfortable completing a simple DIY project.",

  shortDescription:
    "DIY feeder ports for building a larger-capacity gravity feeder.",
  ...
  bullets: [
    "Useful for bucket and barrel feeder projects",
    "Can reduce how often the feeder must be refilled",
    "Allows the feeder capacity to be customized for the flock"
  ],
...
"PRD-005": {
  ...
  badge:
    "Rodent Protection Feeder",

  title:
    "Grandpa's Feeders Automatic Treadle Feeder",

  description:
    "This heavy-duty treadle feeder is designed to keep rodents, wild birds, insects, and weather away from your chicken feed. By opening only when a chicken steps on the platform, it helps reduce wasted feed while protecting stored feed from contamination.",

  shortDescription:
    "Premium treadle feeder designed to protect feed from pests and waste.",
  ...
  bullets: [
    "Excellent protection against rodents and wild birds",
    "Helps reduce spilled and wasted feed",
    "Keeps feed cleaner and drier in outdoor conditions"
  ],
